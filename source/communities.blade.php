...
<a href="https://lit-slack-request.netlify.app" target="_blank" class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mb-8">
...
<a href="https://www.facebook.com/groups/laravel.italia.devs" target="_blank" class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mb-8">
  ...
  <div class="flex flex-col justify-between p-2 leading-normal">
    ...
    <p class="font-normal  p-0 m-0 text-gray-700 dark:text-gray-400">Composta da quesi 3000 membri è rivolta alle discussioni e alle domande</p>
  </div>
</a>
